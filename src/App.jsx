...
const PHONE = '+919109105155'
const WHATSAPP_MSG = encodeURIComponent('Hi! I would like to book a cab with ESSKAY TRAVELS.')
    ...
    <div className="font-dm">
      ...
      <div className="fixed bottom-6 right-5 z-50 flex flex-col gap-3 items-end">
        ...
        <a
          href={`tel:${PHONE}`}
          aria-label="Call us"
          className="flex items-center justify-center w-14 h-14 rounded-full shadow-xl transition-transform hover:scale-110 active:scale-95 bg-gold"
        >
