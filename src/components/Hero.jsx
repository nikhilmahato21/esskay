        ...
        <div className="w-full xl:flex-1">
          ...
          <div className={`flex flex-wrap gap-3 anim-up d5 ${ready ? 'in-view' : ''}`}>
            <a href="tel:+919109105155"
              className="flex items-center gap-2.5 bg-gold hover:bg-gold-dark text-steel font-black px-8 py-4 rounded-full text-sm tracking-wider uppercase transition-all duration-200 no-underline btn-pulse">
            ...
            <a href="https://wa.me/+919109105155?text=Hi%20I%20want%20to%20book%20a%20cab"
              ...
              className="flex items-center gap-2.5 border-2 border-white/20 text-white hover:border-gold hover:text-gold px-8 py-4 rounded-full text-sm tracking-wider uppercase font-black transition-all duration-200 no-underline">
